...
| loc	__REPLACE_ME__/tesuto/test/test.js:14:1
| error	\u001b[31m3 == 4\u001b[39m
...
| loc	__REPLACE_ME__/tesuto/test/test.js:59:2
...
Failed: 2
`
assert.equal(stdout, expectedStdout.replace(/__REPLACE_ME__/g, "file:///C:/Users/Sam/Development"))
...
const expectedStderr = `\u001b[90mAssertionError [ERR_ASSERTION]: 3 == 4
    at __REPLACE_ME__/tesuto/test/test.js:16:2
    at report (__REPLACE_ME__/tesuto/index.js:18:3)
    at __REPLACE_ME__/tesuto/test/test.js:14:1
...
\u001b[90mRangeError: Maximum call stack size exceeded
    at recurse (__REPLACE_ME__/tesuto/test/module1.js:3:17)
    at recurse (__REPLACE_ME__/tesuto/test/module1.js:4:2)
    at recurse (__REPLACE_ME__/tesuto/test/module1.js:4:2)
    at recurse (__REPLACE_ME__/tesuto/test/module1.js:4:2)
    at recurse (__REPLACE_ME__/tesuto/test/module1.js:4:2)
    at recurse (__REPLACE_ME__/tesuto/test/module1.js:4:2)
    ...
    at recurse (__REPLACE_ME__/tesuto/test/module1.js:4:2)
    at recurse (__REPLACE_ME__/tesuto/test/module1.js:4:2)
    at recurse (__REPLACE_ME__/tesuto/test/module1.js:4:2)\u001b[39m
`
assert.equal(stderr, expectedStderr.replace(/__REPLACE_ME__/g, "file:///C:/Users/Sam/Development"))